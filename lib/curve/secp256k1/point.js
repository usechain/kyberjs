 ...
 *
 * @param {module:curves/secp256k1/curve~Weirstrass} curve - Weierstrass curve
...
class Point extends group.Point {
   ...
   *
   * @param {module:curves/secp256k1/point~Point} p2 Point object to compare
   * @return {boolean}
   */
  equal(p2) {
   ...
   *
   * @param {module:curves/secp256k1/point~Point} p2 Point object
   * @return {module:curves/secp256k1/point~Point}
   */
  set(p2) {
    this.ref = p2.ref;
    return this;
   ...
   *
   * @return {module:curves/secp256k1/point~Point} new Point object
   */
  clone() {
  ...
  embed(data, callback) {
    ...
    console.error("secp256k1 point pick failed!!!!!!!!")
  }
   ...
   * Modifies the receiver
   *
   * @param {module:curves/secp256k1/point~Point} p1 Point object, addend
   * @param {module:curves/secp256k1/point~Point} p2 Point object, addend
   * @return {module:curves/secp256k1/point~Point} p1 + p2
   */
  add(p1, p2) {
   ...
   * Modifies the receiver
   *
   * @param {module:curves/secp256k1/point~Point} p1 Point object
   * @param {module:curves/secp256k1/point~Point} p2 Point object
   * @return {module:curves/secp256k1/point~Point} p1 - p2
   */
  sub(p1, p2) {
   ...
   * Modifies the receiver
   *
   * @param {module:curves/secp256k1/point~Point} p Point to negate
   * @return {module:curves/secp256k1/point~Point} -p
   */
  neg(p) {
   ...
   * Modifies the receiver
   *
   * @param {module:curves/secp256k1/scalar~Scalar} s Scalar
   * @param {module:curves/secp256k1/point~Point} [p=null] Point
   * @return {module:curves/secp256k1/point~Point}
   */
  mul(s, p) {
